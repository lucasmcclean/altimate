module github.com/lucasmcclean/altimate/api

go 1.25.1

require (
	github.com/lucasmcclean/adk-go v0.0.0-20250927160640-c0d9c370a83f
...
require (
	...
	github.com/google/dotprompt/go v0.0.0-20250722164332-de6cbf656978 // indirect
